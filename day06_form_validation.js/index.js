...
input.addEventListener("blur", function (e) {
  this.parentElement.style.borderColor = "rgb(243, 240, 240)";
  error.innerText = "";
});
input.addEventListener("input", function (e) {
  ...
  } else if (this.value.length > 3 && this.value.length < 8) {
    error.innerText = "Password is Medium";
    error.style.color = "orange";
    e.target.parentElement.style.borderColor = "orange";
